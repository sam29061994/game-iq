        ...
        <div className="flex h-16 sm:h-20 items-center justify-between">
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            {currentPage === 'summary' && onBack && (
              <Button
                ...
                size="sm"
                onClick={onBack}
                className="text-slate-400 hover:text-white hover:bg-slate-800 h-8 w-8 sm:h-10 sm:w-10 p-0"
              >
            ...
            >
              <div className="flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-full bg-gradient-to-br from-blue-500 to-cyan-500 relative transition-transform group-hover:scale-105">
              ...
              <div>
                <h1 className="text-lg sm:text-xl font-bold text-white group-hover:text-blue-400 transition-colors">GameSheet IQ</h1>
                <p className="text-xs text-slate-400 hidden sm:block">Real-time Player Insights</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <Button
              ...
              className="border-slate-600 bg-slate-800/50 text-slate-300 hover:bg-red-500/10 hover:text-red-400 hover:border-red-500/50 transition-colors px-2 sm:px-3"
            >
